...
> **Versión:** 1.6 · **Fecha:** Mayo 2026 · **Estado:** Draft
...
| `precio_venta`              | numeric (nullable)  | Precio de venta del pack. Nullable: cuando un pack se importa sin precio (Fase 1.4, 18 packs del Excel), se carga `NULL` con `activo = false` hasta que el admin lo complete y active.               |
...
| 1.6     | 2026-05-03 | —     | Fase 1.4 implementada. §4.1 `productos_negocio.precio_venta` pasa a nullable (los 18 packs del Excel sin precio se cargan con `activo=false` hasta que el admin los complete). Migración `20260424050000_alter_productos_negocio_precio_venta_nullable.sql` aplicada. Sin cambios al resto del modelo.                                                                                                                                                                                                                                                                                                                                                                                                          |
